...
parser = argparse.ArgumentParser(description='Multi-VAE and Multi-DAE for recommendation based on collaborative filtering')
...
latent_dims = 200
p_dims = [latent_dims, 600, n_items]
...
def evaluate(data_tr, data_te):
    ...
    return total_loss, np.nanmean(n100_list), np.nanmean(r20_list), np.nanmean(r50_list)
